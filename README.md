# PIE_MAP
PIE_MAP is a C++ mapping application allowing users to view, search, and interact with 19 major cities around the world. Designed for tourists in mind, PIE_MAP has impressive visuals, and an easy and efficient interface where fewer clicks can do more.
